//Taken from https://unity3d.com/pt/learn/tutorials/topics/user-interface-ui/adding-buttons?playlist=17111
using UnityEngine;
...
public class SimpleObjectPool
{
    ...
    public SimpleObjectPool(GameObject prefab, Transform parent){
        this.prefab = prefab;
        this.parent = parent;
